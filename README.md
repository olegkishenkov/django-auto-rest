...
# Guide
## Setup
1. ```python -m pip install --index-url https://test.pypi.org/simple django-auto-rest=0.1.6```
...
```python -m pip install --index-url https://test.pypi.org/simple django-auto-rest=0.1.6```
